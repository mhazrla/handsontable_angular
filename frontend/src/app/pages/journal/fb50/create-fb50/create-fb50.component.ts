...
@Component({
  selector: 'app-create-fb50',
  templateUrl: './create-fb50.component.html',
  styleUrls: ['./create-fb50.component.scss'],
})
export class CreateFb50Component implements OnInit {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          if (this.fb50Form.valid) {
            this.apiService
              .post('journal/fb50/', this.fb50Form.value)
              .subscribe((res: any) => {
